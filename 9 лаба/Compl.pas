...
implementation
  ...
  begin
    ...
    begin
      ClrScr;
      writeln('1. Сложение двух комплексных чисел');
      writeln('2. Умножение двух комплексных чисел');
      writeln('3. Комплексные числа - инверсия');
      writeln('4. Деление двух комплексных чисел');
      writeln('5. Создание комплексного нуля');
      writeln('6. Создание комплексной единицы');
      writeln('7. Модуль комплексного числа');
      writeln('8. Умножение комплексного числа на вещественное');
      writeln('9. Комплексная exp');
      writeln('10.Комплексный sin');
      writeln('11.Комплексный cos');
