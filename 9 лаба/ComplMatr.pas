...
procedure MultMatrix(a, b: Matrix; var c: Matrix);//произведение матриц
var
  i, j, k: integer;
  p, s: Complex;
begin
...
begin
  ...
  begin
    ...
    writeln('4.Единичная матрица');
    writeln('5.Нулевая комплексная матрица');
